...
module.exports = {
    includeCode: function (io) {
        ...
        const PRINTER_PORT = 8000; // Default raw TCP printing port for direct connection

        // Direct TCP printer function - supports multiple printer IPs
        function sendToPrinter(data, printerIP = "10.9.4.177") {
            return new Promise((resolve, reject) => {
                ...
                client.connect(PRINTER_PORT, printerIP, () => {
                    console.log("🖨️ Connected to printer:", printerIP);
                    client.write(data, "utf8", () => {
                        console.log("✅ Print data sent successfully to", printerIP);
                        client.end();
                        if (!isResolved) {
                            isResolved = true;
                            resolve();
                ...
                client.on("timeout", () => {
                    console.error("⏱️ Printer connection timeout:", printerIP);
                    client.destroy();
                    if (!isResolved) {
                        isResolved = true;
                        reject(new Error(`Printer connection timeout: ${printerIP}`));
                    }
                });
...
//////////////////////////////////////////Days Interlock/////////////////////////////////////
            ...
            socket.on('get_rework_alt8_print', (pcknumber,defectlistPrint) => {
                ...
                sendToPrinter(data2, "10.9.4.110")
                    .then(() => console.log(`🎉 REWORK_ALTPACK print job completed for ${pcknumber}`))
                    .catch((err) => console.error("⚠️ REWORK_ALTPACK print job failed:", err));
            });
...
^PQ1,0,1,Y^XZ
    `; 
                   ...
                   /*     fs.writeFile("prn_data/godex_print.prn", data_zebra_new, (err) => {  //"C:\\Program Files (x86)\\Printfil\\Printfil.exe" C:\\Project\\EV_Battery_MIS\\SQL\\ALT_Stations\\Standalone_Airleakage\\prn_data\\file_airleakage_esr.prn LPT1
                      ...
                      //  setTimeout(function () {
                        sendToPrinter(data_tosiba_new, "10.9.4.110")
                            .then(() => console.log("🎉 Tosiba print job completed."))
                            .catch((err) => console.error("⚠️ Tosiba print job failed:", err));
...
{XS;I,0001,0000C6200|}`;
   ...
   `; 
          ...
          /*  fs.writeFile("prn_data/godex_print_alt.prn", data_zebra_new, (err) => {  //"C:\\Program Files (x86)\\Printfil\\Printfil.exe" C:\\Project\\EV_Battery_MIS\\SQL\\ALT_Stations\\Standalone_Airleakage\\prn_data\\file_airleakage_esr.prn LPT1
            ...
            sendToPrinter(data_tosiba_new, "10.9.4.110")
                .then(() => console.log("🎉 Tosiba ALT print job completed."))
                .catch((err) => console.error("⚠️ Tosiba ALT print job failed:", err));
        }
    }
});
});
    ...
    if(packname.trim()==='Limber Rear'){
        sendToPrinter(data_nir, "10.9.4.110")
            .then(() => console.log("🎉 Limber Rear print job completed."))
            .catch((err) => console.error("⚠️ Limber Rear print job failed:", err));
    }    else if(packname.trim()==='Limber Front'){
        sendToPrinter(data_nir, "10.9.4.110")
            .then(() => console.log("🎉 Limber Front print job completed."))
            .catch((err) => console.error("⚠️ Limber Front print job failed:", err));
    }    else{
        sendToPrinter(data1, "10.9.4.110")
            .then(() => console.log("🎉 Default masterprint print job completed."))
            .catch((err) => console.error("⚠️ Default masterprint print job failed:", err));
    }
...
{XS;I,0001,0000C3001|}`;
    ...
    if(packname.trim()==='Limber Rear'){
        ...
        sendToPrinter(data_ejeeto, "10.9.4.110")
            .then(() => console.log("🎉 Ejeeto 21.3 print job completed."))
            .catch((err) => console.error("⚠️ Ejeeto 21.3 print job failed:", err));
    }

    else if(packname.trim()==='Ejeeto 18.4'){
        sendToPrinter(data_ejeeto, "10.9.4.110")
            .then(() => console.log("🎉 Ejeeto 18.4 print job completed."))
            .catch((err) => console.error("⚠️ Ejeeto 18.4 print job failed:", err));
    }
else{
    sendToPrinter(data1, "10.9.4.110")
        .then(() => console.log("🎉 Masterprint print job completed."))
        .catch((err) => console.error("⚠️ Masterprint print job failed:", err));
}
...
{XS;I,0001,0000C6200|}`;
   ...
   `; 
                                ...
                                /*    fs.writeFile("prn_data/godex_print.prn", data_zebra_new, (err) => {  //"C:\\Program Files (x86)\\Printfil\\Printfil.exe" C:\\Project\\EV_Battery_MIS\\SQL\\ALT_Stations\\Standalone_Airleakage\\prn_data\\file_airleakage_esr.prn LPT1
                                 ...
                                 //   setTimeout(function () {
                                sendToPrinter(data_tosiba_new, "10.9.4.110")
                                    .then(() => console.log("🎉 Tosiba assembly print job completed."))
                                    .catch((err) => console.error("⚠️ Tosiba assembly print job failed:", err));
            ...
            packNO = myString;
              ...
              ////////////////////////////////////////////////////////////////////////////////////////////
                ...
                sendToPrinter(data1, "10.9.4.110")
                    .then(() => console.log("🎉 ALT5 file_airleakage6 print job completed."))
                    .catch((err) => console.error("⚠️ ALT5 file_airleakage6 print job failed:", err));
    ...
    if (tee == '0')
     {
        ...
        //  console.log('FFFFFFFFFFF kartiket21::::::::::::::::',myString)
         ...
         packNO = myString;
            ...
            if(packname=="Limber Rear"){
                sendToPrinter(data_nir, "10.9.4.110")
                    .then(() => console.log("🎉 ALT8 Limber Rear print job completed."))
                    .catch((err) => console.error("⚠️ ALT8 Limber Rear print job failed:", err));
            }            
            else if(packname=="Limber Front"){
                sendToPrinter(data_nir, "10.9.4.110")
                    .then(() => console.log("🎉 ALT8 Limber Front print job completed."))
                    .catch((err) => console.error("⚠️ ALT8 Limber Front print job failed:", err));
            }
            else if(packname=="SM eBada Dost"){
                console.log()
                sendToPrinter(data_nir_sm, "10.9.4.110")
                    .then(() => console.log("🎉 ALT8 SM eBada Dost print job completed."))
                    .catch((err) => console.error("⚠️ ALT8 SM eBada Dost print job failed:", err));
            }
            else {
                if(ir_completion_status=="OK"){
                    sendToPrinter(data_nir_sm, "10.9.4.110")
                        .then(() => console.log("🎉 IR OK status print job completed."))
                        .catch((err) => console.error("⚠️ IR OK status print job failed:", err));
            }
            if(ir_completion_status=="NOT OK"){
                sendToPrinter(data_nir_sm, "10.9.4.110")
                    .then(() => console.log("🎉 IR NOT OK status print job completed."))
                    .catch((err) => console.error("⚠️ IR NOT OK status print job failed:", err));
            }
            }
                    ...
                    if (tee == '0')
                     {
                        ...
                        //  console.log('FFFFFFFFFFF kartiket21::::::::::::::::',myString)
                         ...
                         packNO = myString;
                            ...
                            sendToPrinter(data1, "10.9.4.110")
                                .then(() => console.log("🎉 ALT8 rework print job completed."))
                                .catch((err) => console.error("⚠️ ALT8 rework print job failed:", err));
                                // setTimeout(function () {
